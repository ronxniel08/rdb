<div class="modal" tabindex="-1" role="dialog" id="deployEquipment" style="">
		...
		<div class="modal-content">
			<div class="alert alert-danger" style="display:none">
				...
				<div class="modal-header" style="background-color: cyan">
								        ...
								        <h3 class="modal-title">Deploying of Equipment</h3>
								      ...
								      <div class="modal-body">
								          ...
								          <div class="row">
								            <div class="form-group col-md-11">
								              ...
								              <span style="display: inline-block; width: 22em;margin-left: 60px;"><input type="text" class="form-control" name="e_name" id="name" disabled="disabled"></span>
								            </div>
								          </div>
								          <br>
								          ...
								          <div class="row">
								            <div class="form-group col-md-11">
								              ...
								              <select class="form-control" name="project" required="required">
								                	<option value="" style="background-color: lightgray;">Project Location</option>
