...
$sqlRepair = "SELECT * FROM tbl_notify WHERE seen_mech ='No'";
$RepairAll = mysqli_query($conn, $sqlRepair);
$repairCheckAll =  mysqli_num_rows($RepairAll);
  ?>
...
<html class="fixed sidebar-left-collapsed">
	<head>
		...
		<title>CPMMS | RDB Mechanic</title>
								...
								<ul class="nav nav-main">
									...
									<li>
										<a href="notification.php">
											...
											<span class="badge"><?php echo $repairCheckAll ?></span>
